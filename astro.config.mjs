...
export default defineConfig({
  ...
  vite: {
    define: {
      'import.meta.env.AIRTABLE_API_KEY': JSON.stringify(envVars.AIRTABLE_API_KEY || process.env.AIRTABLE_API_KEY),
      'import.meta.env.AIRTABLE_BASE_ID': JSON.stringify(envVars.AIRTABLE_BASE_ID || process.env.AIRTABLE_BASE_ID),
    },
  },
});